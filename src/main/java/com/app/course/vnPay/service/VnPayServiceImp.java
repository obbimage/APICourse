...
//        resp.getWriter().write(gson.toJson(job));
    ...
    @Override
    public String createPayment(long userId, long courseId, String returnUrl, HttpServletRequest req) throws UnsupportedEncodingException {
        String vnp_Version = "2.1.0";
        String vnp_Command = "pay";
        String orderType = "other";
        ...
        long amount = Long.parseLong(String.valueOf(course.getPrice() * 100));

        // set return url
        if (returnUrl == null) {
            Config.setVnp_ReturnUrl(userId, courseId);
        }else{
            Config.setVnp_ReturnUrl(returnUrl,userId,courseId);
        }
